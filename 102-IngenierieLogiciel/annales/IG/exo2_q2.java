/******************************************************************************
 * 
Si on laisse la méthode abstraite dans la classe Héro, on doit le rédéfinir dans le sous-classe
et donc c'est la méthode la plus spécialisé qui est invoqué 
